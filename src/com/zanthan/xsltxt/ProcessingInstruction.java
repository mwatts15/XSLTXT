...
public class ProcessingInstruction
	...
	Logger.getLogger(ProcessingInstruction.class);

    final static String IDENT = PROCESSING_INSTRUCTION;
    
    static StatementDescriptor desc = new StatementDescriptor();

    static {
	desc.setTXTName(IDENT);
	desc.setXMLName("processing-instruction");
// 	desc.setRequiresName(true);
