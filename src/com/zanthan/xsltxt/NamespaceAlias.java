...
public class NamespaceAlias
	...
	Logger.getLogger(NamespaceAlias.class);

    final static String IDENT = NAMESPACE_ALIAS;
    
    static StatementDescriptor desc = new StatementDescriptor();

    static {
	desc.setTXTName(IDENT);
	desc.setXMLName("namespace-alias");

	desc.addRequiredField("stylesheet-prefix");
	desc.addRequiredField("result-prefix");
    }
